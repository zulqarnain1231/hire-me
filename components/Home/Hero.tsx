  ...
  return (
    <ComponentWrapper style="md:h-[calc(100dvh-[144px])]">
      <div className="w-full h-full flex flex-col items-center justify-center gap-10 lg:mt-20 mt-8">
        ...
        <p className="text-white-main text-center sm:text-2xl text-xl font-medium xl:w-[55%] lg:w-[70%]">
        ...
        <div className="w-full flex sm:flex-row flex-col items-center justify-center gap-4">
          <input
            ...
            className="bg-[#3773FF] px-8 py-5 sm:w-[400px] w-full focus:outline-none text-white-main text-base sm:text-lg font-medium placeholder:text-white-main rounded-xl"
          />
          <button className="bg-white-main px-8 py-5 sm:w-auto w-full rounded-xl text-base sm:text-lg font-medium text-brand-main">
            Get Started
          </button>
        </div>
      </div>
